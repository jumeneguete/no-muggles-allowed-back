...
describe("GET /products", () => {
    it("returns status 200 for successful products request", async () => {
        ...
        await connection.query(`INSERT INTO products ("productName", description, price, stock, sku, "productImage")VALUES ('productname', 'testdescription', 7000, 4, 0090, 'testimage')`);
